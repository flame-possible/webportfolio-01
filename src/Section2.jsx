  ...
  return (
    <div className="px-[16px] py-[40px] xl:px-[80px] xl:py-[120px] md:px-[58px] md:py-[80px] bg-white">
        ...
        <div className="flex flex-col gap-[20px] xl:gap-[48px] justify-center items-center">
            ...
            <div className="flex flex-col gap-[16px] lg:px-[120px] lg:gap-[36px] text-center">
                ...
                <div className="flex flex-col gap-[4px]">
                    ...
                    <div className="font-Bagel text-H3-px font-strong text-Primary lg:text-H1-px md:text-H2-px">
                        <p>
                            Between Buns,
                        </p>
                        <p>
